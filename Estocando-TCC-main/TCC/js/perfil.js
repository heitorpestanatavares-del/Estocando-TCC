...
document.addEventListener('DOMContentLoaded', function() {
    ...
    phoneInput.addEventListener('input', function(e) {
        ...
        // Contar quantos caracteres não-dígitos estão antes do cursor
        let caracteresAntesDoCursor = valor.substring(0, cursorPos).replace(/\D/g, '').length;
        ...
        for (let i = 0; i < novoValor.length; i++) {
            ...
            novaPosicao = i + 1;
            if (digitosContados >= caracteresAntesDoCursor) {
                break;
            }
        }
